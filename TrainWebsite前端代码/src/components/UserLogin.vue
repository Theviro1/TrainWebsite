  ...
  methods: {
    async login() {
      ...
      if (this.radio === 3) {
        ...
        console.log(this.password_login);
        await axios
          .get("http://localhost:80/trainAdmin/login", {
            params: { id: this.id_login, password: this.password_login }
          })
          .then(res => {
            console.log(res);
        ...
        console.log(this.password_login);
        await axios
          .get("http://localhost:80/userAdmin/login", {
            params: { id: this.id_login, password: this.password_login }
          })
          .then(res => {
            console.log(res);
    ...
    async sign_up() {
      ...
      if (!this.regid.test(this.sign_up_form.id)) {
        ...
        if (this.signup_radio === 2) {
          ...
          await axios
            .post("http://localhost:80/users/add", this.sign_up_form)
            .then(res => {
              console.log(res);
              if (res.data.success == true) {
                this.$message({
          ...
          console.log(this.sign_up_form);
          await axios
            .post("http://localhost:80/trainAdmin/add", this.sign_up_form)
            .then(res => {
              console.log(res);
              if (res.data.success == true) {
                this.$message({
          ...
          console.log(this.sign_up_form);
          await axios
            .post("http://localhost:80/userAdmin/add", this.sign_up_form)
            .then(res => {
              console.log(res);
              if (res.data.success == true) {
                this.$message({
