<template>
  <el-container>
    <el-header>
      <img src="../assets/logo.png" style="height: 70px;width: 150px;margin-left: 20px;" />
      <el-menu mode="horizontal" class="el-menu-demo" style="float: right;">
        ...
        <!-- 进入个人中心 -->
        <el-menu-item v-if="$store.state.loginstatus != ''" style="font-size: 15px;" @click.native="to_person()">
          <i class="el-icon-user"></i>
          <a>您好，{{ this.$store.state.name }} | 个人中心</a>
        </el-menu-item>
        <el-menu-item v-if="$store.state.loginstatus != ''" style="font-size: 15px;" @click.native="exit_system()">
          <i class="el-icon-switch-button"></i>
          <a>退出登录</a>
        </el-menu-item>
        <el-menu-item v-if="$store.state.loginstatus == ''" style="font-size: 15px;" @click.native="to_login()">
          <a>注册 | 登录</a>
        </el-menu-item>
      </el-menu>
    </el-header>
      ...
      <div>
        <el-carousel :interval="4000" type="card" height="400px">
          <el-carousel-item v-for="(item, index) in carouselItems" :key="index">
            <img :src="item" alt="Carousel Item" style="width: 100%;height: 100%;" />
          </el-carousel-item>
        </el-carousel>
      </div>
      <!-- <div class="box_1">
      ...
      <div class="cards-container" id="section_hot">
        <el-card class="box-card ">
          <div slot="header" class="clearfix">
            ...
            <el-button style="float: right; padding: 3px 0"><i class="el-icon-s-marketing"
                style="font-size: 35px;border: none;"></i></el-button>
          </div>
          ...
          <el-card class="small-card" style="background-color: #C4DFF9;">
            <div>
              <img src="@/assets/pages/train_1.jpg" class="train_pic" alt="" height="100px" width="160px"
                style="display: inline-block; vertical-align: top;" />
              <div style="display: inline-block; vertical-align: top;">
                <span class="image-text_1"> 23060601次 </span>
                <br />
                <span class="u-tag blue"> 北京 —> 广州 </span>
                <br />
                <div>
                  <span class="image-text_3"> 推荐指数 </span>
                  <el-rate v-model="train_value" disabled show-score text-color="#ff9900" score-template="3.7">
                  </el-rate>
                </div>
              </div>
            </div>
          ...
          <el-card class="small-card" style="background-color: #C4DFF9;">
            <div>
              <img src="@/assets/pages/train_2.jpg" class="train_pic" alt="" height="100px" width="160px"
                style="display: inline-block; vertical-align: top;" />
              <div style="display: inline-block; vertical-align: top;">
                <span class="image-text_1"> 23060602次 </span>
                <br />
                <span class="u-tag blue"> 上海 —> 长沙 </span>
                <br />
                <span class="image-text_3"> 推荐指数 </span>
                <el-rate v-model="train_value_2" disabled show-score text-color="#ff9900" score-template="4.5">
                </el-rate>
              </div>
            </div>
          </el-card>
          ...
          <el-card class="small-card" style="background-color: #C4DFF9;">
            <div>
              <img src="@/assets/pages/train_3.jpg" class="train_pic" alt="" height="100px" width="160px"
                style="display: inline-block; vertical-align: top;" />
              <div style="display: inline-block; vertical-align: top;">
                <span class="image-text_1"> 23060603次 </span>
                <br />
                <span class="u-tag blue"> 福州 —> 北京 </span>
                <br />
                <span class="image-text_3"> 推荐指数 </span>
                <el-rate v-model="train_value_3" disabled show-score text-color="#ff9900" score-template="5.0">
                </el-rate>
              </div>
            </div>
          </el-card>
        ...
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            ...
            <el-button style="float: right; padding: 3px 0"><i class="el-icon-knife-fork"
                style="font-size: 35px;border: none;"></i></el-button>
          </div>
          <el-card class="small-card" style="background-color: #7cf0bb;">
            <div>
              <img src="@/assets/pages/food_1.jpg" class="train_pic" alt="" height="100px" width="160px"
                style="display: inline-block; vertical-align: top;" />
              <div style="display: inline-block; vertical-align: top;">
                <i class="el-icon-dish-1" style="font-size: 35px;border: none;"></i>
                <br />
                <br />
          ...
          <el-card class="small-card" style="background-color: #7cf0bb;">
            <div>
              <img src="@/assets/pages/food_2.jpg" class="train_pic" alt="" height="100px" width="160px"
                style="display: inline-block; vertical-align: top;" />
              <div style="display: inline-block; vertical-align: top;">
                <i class="el-icon-burger" style="font-size: 35px;border: none;"></i>
                <br />
                <br />
          ...
          <el-card class="small-card" style="background-color: #7cf0bb;">
            <div>
              <img src="@/assets/pages/food_3.jpg" class="train_pic" alt="" height="100px" width="160px"
                style="display: inline-block; vertical-align: top;" />
              <div style="display: inline-block; vertical-align: top;">
                <i class="el-icon-food" style="font-size: 35px;border: none;"></i>
                <br />
                <br />
        ...
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            ...
            <el-button style="float: right; padding: 3px 0"><i class="el-icon-chat-line-round"
                style="font-size: 35px;border: none;"></i></el-button>
          </div>
          <el-card class="small-card" style="background-color: #cdf07c; height: 466px;">
            <div>
              <img src="@/assets/pages/message_1.jpg" class="train_pic" alt="" height="100px" width="160px"
                style="display: inline-block; vertical-align: top;" />
              <div class="scrollable-div" style="display: inline-block; vertical-align: top;">
...
@keyframes scrollUp {
  ...
  25% {
    top: -20px;
    /* 每次滚动的距离，根据文本行高和数量进行调整 */
  }

  100% {
    top: -80px;
    /* 滚动的总距离，根据文本行高和数量进行调整 */
  }
}
