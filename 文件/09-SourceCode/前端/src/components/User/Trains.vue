  ...
  <div>
    ...
    <el-dialog :visible.sync="editDialogVisible" title="修改列车信息" width="30%" @close="editDialogClosed('editform')">
      <el-form ref="Edit_Form" :model="editForm" :rules="EditTrainRules" label-width="100px">
        ...
        <el-form-item label="始发站" prop="departurePlatformId" width = "100px">
...
export default {
  ...
  methods: {
    ...
    async getTrainsList() {
      await axios.get('http://123.57.3.84/train').then((res) => {
        console.log(1)
        console.log(res)
        const { data } = res.data
        console.log(data)
    ...
    async searchTrainsList(query_a) {
      ...
      await axios.get('http://123.57.3.84/searchOneTrain', { params: { id: query_a } }).then((res) => {
        console.log(1)
        console.log(res)
        const { data } = res.data
        console.log(data)
    ...
    async status_change_query(value) {
      await axios.get('http://123.57.3.84/train/search/status', { params: { status: value } }).then((res) => {
        console.log(1)
        console.log(res)
        const { data } = res.data
        console.log(data)
    ...
    async time_query() {
      ...
      await axios.get('http://123.57.3.84/train/search/datescope', { params: { date1: date1Str, date2: date2Str } }).then((res) => {
        console.log(1)
        console.log(res)
        const { data } = res.data
        console.log(data)
      ...
      if (
        ...
        this.$refs.form.validate(async (valid) => {
          ...
          if (!valid) {
            ...
            console.log(this.addForm)
            await axios
              .post("http://123.57.3.84/train/add", this.addForm)
              .then((res) => {
                console.log(res)
    ...
    async saveEditForm() {
      this.$refs.Edit_Form.validate(async (valid) => {
        ...
        if (!valid) {
          ...
          console.log(this.editForm)
          await axios
            .put('http://123.57.3.84/train/update', this.editForm)
            .then((res) => {
              console.log(res)
              if (res.data.success == true) {
                this.$message({
    ...
    async handleDelete(id) {
      ...
      await axios
        .delete('http://123.57.3.84/train/delete', { params: { id: id } })
        .then((res) => {
          console.log(res)
          if (res.data.success == true) {
            this.$message({
