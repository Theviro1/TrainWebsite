...
export default {
  ...
  methods: {
    async getUsersList() {
      ...
      await axios.get("http://123.57.3.84/users").then(res => {
        console.log(1);
        console.log(res);
        const { data } = res.data;
        console.log(data);
    ...
    async searchUsersList(query_a) {
      await axios.get("http://123.57.3.84/users/fuzzySearch", { params: { condition: query_a } }).then(res => {
        console.log(1);
        console.log(res);
        const { data } = res.data;
        console.log(data);
    ...
    async saveForm() {
      this.$refs.form.validate(async valid => {
        ...
        if (!valid) {
          ...
          await axios.post("http://123.57.3.84/users/add", this.addForm).then(res => {
            console.log(res);
    ...
    async saveEditForm() {
      this.$refs.Edit_Form.validate(async valid => {
        ...
        if (!valid) {
          ...
          console.log(this.editForm);
          await axios.put("http://123.57.3.84/users/update", this.editForm).then(res => {
            console.log(res);
            if (res.data.success == true) {
              this.$message({
                message: res.data.message,
    ...
    async handleDelete(id) {
      ...
      await axios.delete("http://123.57.3.84/users/delete", { params: { id: id } }).then(res => {
        console.log(res);
        if (res.data.success == true) {
          this.$message({
            message: res.data.message,
