...
export default {
  ...
  methods: {
    ...
    async getSeatsList(trainid) {
      await axios
        .get('http://123.57.3.84/train/seat', { params: { id: trainid } })
        .then((res) => {
          console.log(1)
          console.log(res)
          const { data } = res.data
    ...
    async searchSeatsList(query_a) {
      await axios.get('http://123.57.3.84/seat/search/id', { params: { trainId: this.$store.state.trainid, seatId: query_a } }).then((res) => {
        console.log(1)
        console.log(res)
        const { data } = res.data
        console.log(data)
    ...
    async type_change_query(value) {
      await axios.get('http://123.57.3.84/seat/search/type', { params: { trainId: this.$store.state.trainid, type: value } }).then((res) => {
        console.log(1)
        console.log(res)
        const { data } = res.data
        console.log(data)
    ...
    async saveEditForm() {
      this.$refs.Edit_Form.validate(async (valid) => {
        ...
        if (!valid) {
          ...
          console.log(this.editForm)
          await axios
            .put("http://123.57.3.84/train/seat/update", this.editForm)
            .then((res) => {
              console.log(res)
